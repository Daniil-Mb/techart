<div class="container">
    ...
    foreach ($data as $info) {
        ?>
        <div class="news">
            <p class="news__page">Главная / <span class="news__colored-page"><?= $info['title'] ?></span></p>
            <h1 class="news__head"><?= $info['title'] ?></h1>
            <div class="news__contant">
                <div class="news__news">
                    <div class="news__border">
                        <p class="news__date"><?= $info['date'] ?></p>
                    </div>
                    <h3 class="news__header"><?= $info['announce'] ?></h3>
                    <p class="news__text"><?= $info['content'] ?></p>
                ...
                <div class="news__img-div">
                    <img class="news__img" src="<?= $STATIC_DIR ?>/images/<?= $info['image'] ?>" alt="img">
                </div>
            </div>
        </div>
        <?php
